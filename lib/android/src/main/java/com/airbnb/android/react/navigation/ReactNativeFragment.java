...
public class ReactNativeFragment extends Fragment implements ReactInterface, DefaultHardwareBackBtnHandler {
...
//    private List<MenuButton> menuButtons;
    ...
    private void onCreateWithReactContext() {
        ...
        if (reactRootView == null) {
            ViewStub reactViewStub = getView().findViewById(R.id.react_root_view_stub);
...
//    }
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ReactToolbarFacade toolbar = getToolbar();
        if (toolbar != null) {
...
//        }
    ...
    private void emitEvent(String eventName, Object object) {
        if (isSuccessfullyInitialized()) {
            ...
            maybeEmitEvent((ReactContext) reactInstanceManager.getCurrentReactContext(), key, object);
        }
    }
}
