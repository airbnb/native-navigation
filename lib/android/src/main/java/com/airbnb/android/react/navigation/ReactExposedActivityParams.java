...
public class ReactExposedActivityParams {
    ...
    public ReactExposedActivityParams(ObjectMapper objectMapper, String key, Class<? extends Activity> klass) {
    ...
    /**
     * Converts the provided {@link ReadableMap} arguments into an {@link Intent} used for launching the {@link Activity} associated with this object.
     * The {@code arguments} will be used as {@link Intent} {@code extras} and converted according to the {@code argumentType} field. By default, all
     * activities will take a {@link Bundle} extra, however, if a custom {@code argumentType} class is provided, the {@code arguments} will be
     * automatically converted into an object of the type {@code argumentType} instead, by using Jackson to deserialize the contents of {@code
     * arguments}.
     */
