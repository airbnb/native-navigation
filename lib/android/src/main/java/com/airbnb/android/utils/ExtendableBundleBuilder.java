 ...
 * @param <T> The class that is extending this like: class Foo extends ExtendableBundleBuilder<Foo> which allows
 *           the builder pattern via returning the parent class for each bundle operation.
 */
