...
final class SharedElement: RCTView {
  ...
  func setAirbnbInstanceId(_ airbnbInstanceId: String!) {
  ...
  override func insertReactSubview(_ subview: UIView, at index: Int) {
    ...
    guard let seid = identifier, let id = airbnbInstanceId else { return }
  ...
  fileprivate var airbnbInstanceId: String?
}
